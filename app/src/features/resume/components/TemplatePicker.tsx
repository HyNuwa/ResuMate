...
import { CV_TEMPLATES, type TemplateId, type TemplateCategory } from '@/templates';
...
const CATEGORY_ORDER: TemplateCategory[] = ['classic', 'modern', 'professional'];
...
export function TemplatePicker({ onApply, onCancel }: TemplatePickerProps) {
  ...
  const grouped = CATEGORY_ORDER.map((cat) => ({
    ...
    templates: CV_TEMPLATES.filter((t) => t.category === cat),
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
      <div className="relative flex w-full max-w-4xl max-h-[90vh] rounded-2xl overflow-hidden shadow-2xl bg-[#111827]">
        ...
        <div className="w-80 shrink-0 flex flex-col p-6 gap-5 border-l border-white/[0.07]">
